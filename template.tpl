...

{
  ...
  "description": "If you do not have a \"standard\" or \"enhanced\" structured dataLayer, you can use this template to pass your custom data.",
  "securityGroups": [],
...
/**
Handle the item level data provided

products   array   All the product data
**/
...
/**
Read through all the parameters they want to pass

item   object  The current element
...
Created on 8/4/2021, 1:44:29 PM
